...
some_text = """One morning when Gregor Samsa woke from troubled dreams he found himself transformed in his bed into a horrible vermin He lay on his armourlike back and if he lifted his head a little he could see his brown belly slightly domed and divided by arches into stiff sections"""
text_box_left = (MARGIN, MARGIN + MARGIN, MARGIN*6.5, MARGIN*10.5)
text_box_right = (MARGIN + MARGIN*7.5, MARGIN + MARGIN, MARGIN*6.5, MARGIN*10.5)
fill(.5)
#rect(*text_box_left)
#rect(*text_box_right)
fill(1)
textBox(some_text*6, text_box_left, align='left')
hyphenation(True)
textBox(some_text*6, text_box_right, align='left')
hyphenation(False)
tracking(None)
fontVariations(wght=700)
fontSize(MARGIN / 2)
text("Metamorphosis", (MARGIN, MARGIN*13))
text("Metamorphosis", (MARGIN + MARGIN*7.5, MARGIN*13))
