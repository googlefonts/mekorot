...
latin_plus_hebrew_text = "Eliyahu Hanavie Eliyahu Hatishbi Elyahu Hagiladi Bimherah Yavo Elenu Im Mashiach Ben David אֵלִיָהוּ הַנָבִיא אֵלִיָהוּ הַתִּשְׁבִּי "
text_box_a = (MARGIN*1., MARGIN * 2.5, MARGIN*6.5, MARGIN*11.0)
text_box_b = (MARGIN*8., MARGIN * 2.5, MARGIN*6.5, MARGIN*11.0)
...
language("en")
textBox(latin_plus_hebrew_text*19, text_box_a, align='left')
fontVariations(wght=700)
textBox(latin_plus_hebrew_text*19, text_box_b, align='left')
fontVariations(wght=400)
