...
def draw_image():
    ...
    fontSize(GRID_UNIT * 2.2)
    tracking(-4)
    text("The Design of the UNIX", (MARGIN, MARGIN*6.5))
    #text("of the UNIX", (MARGIN, MARGIN*6))
    text("Operating System", (MARGIN, MARGIN*6))
    #lineHeight(260)
    #textBox(
    #    "The Design of the UNIX Operating System",
    #    (MARGIN, GRID_UNIT * 18.75, (WIDTH - MARGIN *2) , GRID_UNIT * 9),
    #    align="left",
    #)
    #rect(MARGIN, GRID_UNIT * 22, WIDTH - MARGIN *2, GRID_UNIT * 6.7)
